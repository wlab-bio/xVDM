...
def initiate_hash_alignment(uxi_file,base_count_filterval=None,line_match=True):
    '''
    ...
    if not (sysOps.check_file_exists("sorted_indexed_" + uxi_file) or sysOps.check_file_exists(identical_uxi_file)):
